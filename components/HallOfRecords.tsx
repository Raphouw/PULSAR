...
export const UI_CONFIG: Record<string, any> = {
    ...
    'time_1k': { label: '1 km', icon: Timer, unit: '', color: '#00f3ff', tab: 'time_dist', inverse: true, format: 'time', target: 1000 },
    'time_3k': { label: '3 km', icon: Timer, unit: '', color: '#00f3ff', tab: 'time_dist', inverse: true, format: 'time', target: 3000 },
    'time_5k': { label: '5 km', icon: Timer, unit: '', color: '#00f3ff', tab: 'time_dist', inverse: true, format: 'time', target: 5000 },
    'time_10k': { label: '10 km', icon: Timer, unit: '', color: '#00f3ff', tab: 'time_dist', inverse: true, format: 'time', target: 10000 },
    'time_20k': { label: '20 km', icon: Timer, unit: '', color: '#00f3ff', tab: 'time_dist', inverse: true, format: 'time', target: 20000 },
    'time_30k': { label: '30 km', icon: Timer, unit: '', color: '#00f3ff', tab: 'time_dist', inverse: true, format: 'time', target: 30000 },
    'time_40k': { label: '40 km', icon: Timer, unit: '', color: '#00f3ff', tab: 'time_dist', inverse: true, format: 'time', target: 40000 },
    'time_50k': { label: '50 km', icon: Timer, unit: '', color: '#00f3ff', tab: 'time_dist', inverse: true, format: 'time', target: 50000 },
    'time_75k': { label: '75 km', icon: Timer, unit: '', color: '#00f3ff', tab: 'time_dist', inverse: true, format: 'time', target: 75000 },
    'time_100k': { label: '100 km', icon: Timer, unit: '', color: '#00f3ff', tab: 'time_dist', inverse: true, format: 'time', target: 100000 },
    'time_150k': { label: '150 km', icon: Timer, unit: '', color: '#00f3ff', tab: 'time_dist', inverse: true, format: 'time', target: 150000 },
    'time_160k': { label: '100 miles', icon: Timer, unit: '', color: '#00f3ff', tab: 'time_dist', inverse: true, format: 'time', target: 160934 },
    'time_200k': { label: '200 km', icon: Timer, unit: '', color: '#00f3ff', tab: 'time_dist', inverse: true, format: 'time', target: 200000 },

    // KM / TEMPS
    'dist_1m': { label: '1 min', icon: Map, unit: 'km', color: '#f43f5e', tab: 'dist_time', duration: 60 },
    'dist_5m': { label: '5 min', icon: Map, unit: 'km', color: '#f43f5e', tab: 'dist_time', duration: 300 },
    'dist_15m': { label: '15 min', icon: Map, unit: 'km', color: '#f43f5e', tab: 'dist_time', duration: 900 },
    'dist_30m': { label: '30 min', icon: Map, unit: 'km', color: '#f43f5e', tab: 'dist_time', duration: 1800 },
    'dist_1h': { label: '1 heure', icon: Map, unit: 'km', color: '#f43f5e', tab: 'dist_time', duration: 3600 },
    'dist_2h': { label: '2 heures', icon: Map, unit: 'km', color: '#f43f5e', tab: 'dist_time', duration: 7200 },
    'dist_3h': { label: '3 heures', icon: Map, unit: 'km', color: '#f43f5e', tab: 'dist_time', duration: 10800 },
    'dist_4h': { label: '4 heures', icon: Map, unit: 'km', color: '#f43f5e', tab: 'dist_time', duration: 14400 },
    'dist_5h': { label: '5 heures', icon: Map, unit: 'km', color: '#f43f5e', tab: 'dist_time', duration: 18000 },
    'dist_10h': { label: '10 heures', icon: Map, unit: 'km', color: '#f43f5e', tab: 'dist_time', duration: 36000 },
};
