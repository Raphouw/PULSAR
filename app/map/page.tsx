  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={headerStyle}>
        ...
        <h1 style={titleStyle}>MAP & HEATMAP global</h1>
        <p style={subtitleStyle}>Visualisation de toutes les sorties sur la même carte</p>
      </div>
      ...
      <div style={constructionCardStyle}>
        ...
        <div style={featuresGridStyle}>
            <div style={featureItemStyle}>
                <span style={checkStyle}>⚡</span> Cluster / Carrés
            </div>
            <div style={featureItemStyle}>
                <span style={checkStyle}>📅</span> Récompenses
            </div>
            <div style={featureItemStyle}>
                <span style={checkStyle}>🔄</span> Exploration
            </div>
            <div style={featureItemStyle}>
                <span style={checkStyle}>🤖</span> Vision globale
            </div>
        </div>
