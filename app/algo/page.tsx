  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={headerStyle}>
        ...
        <h1 style={titleStyle}>Alogrithmes & usage</h1>
        <p style={subtitleStyle}>Comment fonctionne le site et calculs/prédiction de vos données</p>
      </div>
      ...
      <div style={constructionCardStyle}>
        ...
        <div style={featuresGridStyle}>
            <div style={featureItemStyle}>
                <span style={checkStyle}>⚡</span> MATHEMATIQUES
            </div>
            <div style={featureItemStyle}>
                <span style={checkStyle}>📅</span> PHYSIQUE
            </div>
            <div style={featureItemStyle}>
                <span style={checkStyle}>🔄</span> Tips
            </div>
            <div style={featureItemStyle}>
                <span style={checkStyle}>🤖</span> Expértise
            </div>
        </div>
